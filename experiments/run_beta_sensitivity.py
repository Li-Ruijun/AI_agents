...
# Fixed parameters: only beta changes in this experiment.
FIXED_PARAMETERS = {
    "N": 400,
...
# Beta values tested in this experiment.
BETAS = [
    0.10,
    0.30,
    0.50,
...
def build_settings():
    ...
    for setting_id, beta in enumerate(BETAS, start=1):
        parameter_setting = (
...
def setting_file_label(setting):
    return f"beta_{setting['beta']:.2f}".replace(".", "p")
...
if __name__ == "__main__":
    ...
    print("Experiment: beta sensitivity analysis")
