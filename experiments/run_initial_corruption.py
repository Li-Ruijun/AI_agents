...
# Fixed parameters: only the initial corruption rate changes in this experiment.
FIXED_PARAMETERS = {
    "N": 400,
    "beta": 0.50,
...
# Initial corruption probabilities tested in this experiment.
...
def setting_file_label(setting):
    return (
        f"initial_{setting['initial_corruption_rate']:.2f}"
        .replace(".", "p")
    )
...
if __name__ == "__main__":
    ...
    print("Experiment: initial corruption sensitivity analysis")
